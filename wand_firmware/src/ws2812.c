...
//    }
//}
// Macro to generate exact number of NOPs for any cycle count
...
//        for (int8_t bit = 7; bit >= 0; bit--) {
//            if (byte & (1 << bit)) {
//                // Send '1' bit: 34 NOPs high + overhead = ~0.8?s, 18 NOPs low + overhead = ~0.45?s
//                *set_reg = pin_mask;
//                __asm__ __volatile__(
//                    "nop\n nop\n nop\n nop\n nop\n nop\n nop\n nop\n"    // 8
//                    "nop\n nop\n nop\n nop\n nop\n nop\n nop\n nop\n"    // 16
...
//                    ::: "memory");
//            } else {
//                // Send '0' bit: 15 NOPs high + overhead = ~0.4?s, 37 NOPs low + overhead = ~0.85?s
//                *set_reg = pin_mask;
//                __asm__ __volatile__(
//                    "nop\n nop\n nop\n nop\n nop\n nop\n nop\n nop\n"    // 8
//                    "nop\n nop\n nop\n nop\n nop\n nop\n nop\n"          // 15
...
//    }
//    
//    // Reset signal: 50?s = 2400 cycles
//    *clr_reg = pin_mask;
//    ws2812_delay_cycles(790);
//    
//    __enable_irq();
//    ws2812_transmission_complete = true;
//}
