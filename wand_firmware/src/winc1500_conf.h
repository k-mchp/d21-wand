...
#define TCP_SERVER_IP_ADDR  "192.168.0.1"
#define TCP_SERVER_PORT_NUM 12345
#define TCP_BUFFER_SIZE     15


#define UDP_SERVER_IP_ADDR   "192.168.1.1"
#define UDP_SERVER_PORT_NUM   6666
#define UDP_BUFFER_SIZE     15
